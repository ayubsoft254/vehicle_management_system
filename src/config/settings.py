...
ALLOWED_HOSTS = ['*']  # Update this in production to specific domains
...
# SECURE_SSL_REDIRECT is handled in the production settings block below
...
MIDDLEWARE = [
    ...
    'apps.audit.middleware.ExceptionEmailNotificationMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.dashboard.context_processors.company_info',
            ],
        },
    },
]
