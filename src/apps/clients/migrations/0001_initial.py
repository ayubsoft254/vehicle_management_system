    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kra_pin', models.CharField(blank=True, help_text='Kenya Revenue Authority Personal Identification Number', max_length=20, null=True, verbose_name='KRA PIN')),
                ('phone_primary', models.CharField(help_text='International or local format accepted', max_length=20, verbose_name='Primary Phone')),
                ('phone_secondary', models.CharField(blank=True, help_text='Alternative phone number (optional)', max_length=20, verbose_name='Secondary Phone')),
                ...
                ('user', models.OneToOneField(blank=True, help_text='Linked user account for client portal access', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='client_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Client',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.CharField(choices=[('full', 'Pay in Full'), ('installment', 'Monthly Installments'), ('flexible', 'Flexible (Monthly or Weekly)')], default='installment', help_text='How the client will pay for the vehicle', max_length=20, verbose_name='Payment Type')),
                ('remainder_payment_type', models.CharField(blank=True, choices=[('monthly', 'Monthly'), ('weekly', 'Weekly')], default='monthly', help_text='Whether remainder is paid monthly or weekly', max_length=20, null=True, verbose_name='Remainder Payment Type')),
                ('monthly_payment_date', models.IntegerField(blank=True, default=12, help_text='Day of month for monthly payments (1-31, e.g., 12 for 12th of month)', null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Monthly Payment Date')),
                ('weekly_payment_day', models.IntegerField(blank=True, choices=[(0, 'Monday'), (1, 'Tuesday'), (2, 'Wednesday'), (3, 'Thursday'), (4, 'Friday'), (5, 'Saturday'), (6, 'Sunday')], default=2, help_text='Day of week for weekly payments (0=Monday, 6=Sunday)', null=True, verbose_name='Weekly Payment Day')),
                ('allow_flexible_payments', models.BooleanField(default=False, help_text='Allow client to make payments at any time, with flexible scheduling', verbose_name='Allow Flexible Payments')),
        ...
        migrations.CreateModel(
            name='VehicleSaleWitness',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('broker', 'Broker'), ('witness', 'Witness'), ('other', 'Other')], default='witness', max_length=20, verbose_name='Role')),
                ...
                ('client_vehicle', models.ForeignKey(help_text='Vehicle sale this witness is linked to', on_delete=django.db.models.deletion.CASCADE, related_name='witnesses', to='clients.clientvehicle')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tracker_name', models.CharField(help_text='e.g. Teltonika FMB920', max_length=200, verbose_name='Tracker Name / Model')),
                ('serial_number', models.CharField(blank=True, help_text='Device serial number or IMEI', max_length=100, verbose_name='Serial Number / IMEI')),
                ('provider', models.CharField(blank=True, help_text='Company or person supplying the tracker', max_length=200, verbose_name='Provider / Vendor')),
                ('buying_price', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Amount dealer paid for this tracker', max_digits=12, verbose_name='Buying Price (KES)')),
                ('selling_price', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Amount client is charged for this tracker', max_digits=12, verbose_name='Selling Price (KES)')),
                ('has_payment_plan', models.BooleanField(default=False, help_text='Whether client pays for this tracker in installments', verbose_name='Has Payment Plan')),
                ('deposit', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Deposit (KES)')),
                ('installment_months', models.PositiveIntegerField(blank=True, null=True, verbose_name='Installment Months')),
                ('monthly_installment', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Monthly Installment (KES)')),
                ('total_paid', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Total Paid (KES)')),
                ('balance', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Balance (KES)')),
                ('installed_date', models.DateField(blank=True, null=True, verbose_name='Installation Date')),
                ('notes', models.TextField(blank=True, verbose_name='Notes')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('client_vehicle', models.ForeignKey(help_text='Vehicle purchase this tracker is linked to', on_delete=django.db.models.deletion.CASCADE, related_name='trackers', to='clients.clientvehicle')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='trackers_added', to=settings.AUTH_USER_MODEL)),
            ],
            options={
