...
class PaymentAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        'id', 'client_link', 'vehicle_link', 'payment_date',
        'amount_display', 'payment_method_badge', 'transaction_reference',
...
class InstallmentPlanAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        'id', 'client_link', 'vehicle_link', 'total_amount_display',
        'deposit_display', 'monthly_installment_display',
        'number_of_installments', 'interest_rate_display',
        'start_date', 'end_date'
    ]
    ...
    readonly_fields = ['created_by', 'created_at', 'updated_at', 'end_date']
    ...
    def deposit_display(self, obj):
        """Display deposit formatted"""
        return format_html('KES {:,.2f}', obj.deposit)
