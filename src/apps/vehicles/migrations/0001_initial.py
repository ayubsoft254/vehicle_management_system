    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(help_text='Year the vehicle was manufactured', verbose_name='Year of Manufacture')),
                ('vin', models.CharField(help_text='Unique vehicle identifier (can include hyphens)', max_length=100, unique=True, verbose_name='VIN (Vehicle Identification Number)')),
                ('registration_number', models.CharField(blank=True, help_text='Vehicle registration/license plate number (e.g., KAA 123A)', max_length=20, null=True, unique=True, verbose_name='Registration Number')),
                ('chassis_number', models.CharField(blank=True, help_text='Vehicle chassis number', max_length=100, null=True, unique=True, verbose_name='Chassis Number')),
                ('engine_number', models.CharField(blank=True, help_text='Vehicle engine number', max_length=100, null=True, verbose_name='Engine Number')),
                ('color', models.CharField(help_text='Exterior color', max_length=50, verbose_name='Color')),
                ('mileage', models.IntegerField(help_text='Current mileage in kilometers', verbose_name='Mileage (KM)')),
                ...
                ('doors', models.IntegerField(default=4, verbose_name='Number of Doors')),
