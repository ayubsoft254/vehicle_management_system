    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buying_price', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Amount dealer paid the insurance company', max_digits=12, verbose_name='Buying Price (KES)')),
                ('selling_price', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Amount charged to client for insurance', max_digits=12, verbose_name='Selling Price (KES)')),
                ('agent_name', models.CharField(blank=True, help_text='Insurance agent name', max_length=200, verbose_name='Agent Name')),
                ('agent_id', models.CharField(blank=True, help_text='Agent ID, license number, or phone', max_length=100, verbose_name='Agent ID / Number')),
                ('has_payment_plan', models.BooleanField(default=False, help_text='Whether client pays insurance in installments', verbose_name='Has Payment Plan')),
                ('insurance_deposit', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Insurance Deposit (KES)')),
                ('insurance_installment_months', models.PositiveIntegerField(blank=True, null=True, verbose_name='Insurance Installment Months')),
                ('insurance_monthly_installment', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Monthly Installment (KES)')),
                ('insurance_total_paid', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Total Paid (KES)')),
                ('insurance_balance', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Insurance Balance (KES)')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
